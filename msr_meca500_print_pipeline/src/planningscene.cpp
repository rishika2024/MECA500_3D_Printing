...
public:
  ...
  : Node("meca500_planning_scene")
  {
    ...
    // Service server
    table_server_ = this->create_service<msr_meca500_print_pipeline::srv::Table>(
      "table_service",
...
private:
  ...
  rclcpp::Service<msr_meca500_print_pipeline::srv::Table>::SharedPtr table_server_;
  rclcpp::TimerBase::SharedPtr timer;

  void table_callback(
    const std::shared_ptr<msr_meca500_print_pipeline::srv::Table::Request>  req,
          std::shared_ptr<msr_meca500_print_pipeline::srv::Table::Response> res)
  {
